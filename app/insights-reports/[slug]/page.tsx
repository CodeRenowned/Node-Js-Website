...
import { getInsight, getInsightSlugs, getFeaturedImage, formatDate } from '@/lib/wordpress'
    ...
    <>
      <section className="bg-gradient-to-br from-navy to-[#1d1b4c] py-16">
        <div className="container mx-auto px-5 max-w-4xl">
          <Link href="/insights-reports" className="inline-flex items-center gap-2 text-white/60 hover:text-white text-sm font-body mb-6 transition-colors">
          ...
          <div className="grid lg:grid-cols-[1fr_300px] gap-12 max-w-6xl mx-auto">
            ...
            <aside className="space-y-6">
              <div className="bg-primary rounded-2xl p-6 text-center">
                ...
                <p className="text-white/80 text-sm font-body mb-5">Apply these insights with expert SEO support.</p>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <div className="space-y-2">
                  <Link href="/insights-reports" className="block text-sm font-body text-gray-600 hover:text-primary transition-colors">← All Insights</Link>
                  <Link href="/blog" className="block text-sm font-body text-gray-600 hover:text-primary transition-colors">Read Our Blog</Link>
                  <Link href="/case-studies" className="block text-sm font-body text-gray-600 hover:text-primary transition-colors">View Case Studies</Link>
                </div>
              </div>
            </aside>
          </div>
